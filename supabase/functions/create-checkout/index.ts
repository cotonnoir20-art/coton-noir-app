...
serve(async (req) => {
  ...
  try {
    ...
    // Create checkout session for premium subscription (9.99€/month)
    ...
    console.log(`[CREATE-CHECKOUT] Created session for user ${user.email}: ${session.id}`);
